      ...
      <div className="max-w-md w-full bg-white border-8 border-black p-6 shadow-[16px_16px_0px_#000000] transform rotate-1">
        ...
        <form onSubmit={handleEmailRegister} className="space-y-6">
          ...
          <div>
            <label
              ...
              className="label-brutalist block mb-2"
            >
              確認密碼
            </label>
            <input
        ...
        <div className="mt-6 text-center bg-pink-400 border-4 border-black p-4">
          <span className="font-bold text-black">
            ...
            <a
              href="/login"
              className="bg-yellow-300 text-black px-3 py-1 border-2 border-black hover:bg-cyan-400 transform hover:scale-105 transition-all duration-100 inline-block"
            >
              立即登入
            </a>
          </span>
